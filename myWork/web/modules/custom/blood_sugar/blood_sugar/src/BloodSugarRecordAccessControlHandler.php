...
/**
 * Access controller for the request access to blood_sugar_record entity.
 *
...
class BloodSugarRecordAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    switch ($operation) {
      case 'view':
        return AccessResult::allowedIfHasPermission($account, 'view blood sugar record entities');
